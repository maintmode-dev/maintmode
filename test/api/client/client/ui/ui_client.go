...
/*
GetUIV1Calendar lists calendar events
...
func (a *Client) GetUIV1Calendar(params *GetUIV1CalendarParams, opts ...ClientOption) (*GetUIV1CalendarOK, error) {
	...
	success, ok := result.(*GetUIV1CalendarOK)
	if ok {
		return success, nil
	}
	...
	msg := fmt.Sprintf("unexpected success response for GetUIV1Calendar: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}

/*
GetUIV1MaintenancesID gets maintenance view
...
func (a *Client) GetUIV1MaintenancesID(params *GetUIV1MaintenancesIDParams, opts ...ClientOption) (*GetUIV1MaintenancesIDOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "GetUIV1MaintenancesID",
		Method:             "GET",
		PathPattern:        "/ui/v1/maintenances/{id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
	...
	// only one success response has to be checked
	success, ok := result.(*GetUIV1MaintenancesIDOK)
	if ok {
		return success, nil
	}
	...
	//
	// safeguard: normally, in the absence of a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetUIV1MaintenancesID: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
