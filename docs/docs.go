...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1//login/oauth/exchange/google": {
            "post": {
                "consumes": [
                    "application/json"
                ],
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apiauthmodels.ExchangeIDTokenRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "INVALID_ID_TOKEN or EMAIL_NOT_VERIFIED",
                        "schema": {
                            "$ref": "#/definitions/httperrors.ErrorResponse"
                        }
                    },
                    "403": {
                        "description": "DOMAIN_NOT_ALLOWED",
                        "schema": {
                            "$ref": "#/definitions/httperrors.ErrorResponse"
                        }
                    },
                ...
                "responses": {
                    "200": {
                        ...
                        "headers": {
                            "Set-Cookie": {
                                "type": "string",
                                "description": "Refresh token cookie (HTML mode only; not set in JSON mode)"
                            }
                        }
                    },
                    "400": {
                        "description": "Missing/invalid/expired/tampered state or nonce mismatch",
                        "schema": {
                            "$ref": "#/definitions/httperrors.ErrorResponse"
                        }
                    },
        ...
        "/api/v1/maintenances/create": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create maintenance draft request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apimodels.CreateDraftMaintRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/apimodels.CreateDraftMaintResponse"
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "format": "uuid",
                        "description": "Maintenance ID (UUID)",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/apimodels.Maintenance"
                        }
                    },
                    "400": {
        ...
        "/api/v1/maintenances/{id}/approve": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Approve maintenance request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apimodels.ApproveDraftMaintRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apimodels.CancelMaintRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apimodels.UpdateDraftMaintRequest"
                        }
                    }
                ],
                "responses": {
                    "204": {
                        "description": "Maintenance draft updated"
                    },
                    "400": {
                        "description": "Invalid request",
                        "schema": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/apiauthmodels.MeResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apimodels.UpdateResourceRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/resource/{id}/unarchive": {
            "post": {
                ...
                "responses": {
                    "204": {
                        "description": "Resource unarchived"
                    },
                    "400": {
                        "description": "Invalid resource id",
                        "schema": {
        ...
        "/api/v1/resources/list": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Case-insensitive partial name match (search box)",
                        "name": "name",
                        "in": "query"
                    },
                    {
                    ...
                    },
                    {
                        "type": "boolean",
                        "default": false,
                        "description": "Include archived resources (false: active only; true: active + archived)",
                        "name": "archived",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/apimodels.ListResourcesResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "description": "Maintenance statuses",
                        "name": "statuses",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/uimodels.CalendarViewResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/uimodels.MaintenanceViewResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid request",
    ...
    "definitions": {
        ...
        "apiauthmodels.ExchangeIDTokenRequest": {
            "type": "object",
            "properties": {
                "id_token": {
                    "description": "IDToken is the upstream provider's signed JWT.",
                    "type": "string"
                }
            }
        },
        ...
        "apiauthmodels.OAuthCallbackJSONResponse": {
            "type": "object",
            "properties": {
                "original_uri": {
                    "type": "string"
        ...
        "apimodels.MaintenanceCancelReason": {
            "type": "string",
            "enum": [
                "conflict",
                "incident",
            ...
            "x-enum-varnames": [
                "MaintenanceCancelReasonConflict",
                "MaintenanceCancelReasonIncident",
                "MaintenanceCancelReasonBusinessDecision",
                "MaintenanceCancelReasonRescheduled",
                "MaintenanceCancelReasonMistake"
            ]
        },
        "apimodels.MaintenanceImpact": {
            "type": "string",
            "enum": [
                "none",
                "partial_outage",
            ...
            "x-enum-varnames": [
                ...
                "MaintenanceImpactPartial",
                "MaintenanceImpactFull"
            ]
        },
        "apimodels.MaintenanceScope": {
            "type": "string",
            "enum": [
                "global",
                "resource"
        ...
        "apimodels.UpdateResourceRequest": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
        ...
        "uimodels.CalendarViewResponse": {
            ...
            "properties": {
                "events": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/uimodels.CalendarEvent"
                    }
                },
                "meta": {
                    "$ref": "#/definitions/uimodels.CalendarViewMeta"
                }
            }
        },
        "uimodels.ConflictView": {
            "type": "object",
            "properties": {
                "maintenance_id": {
                    "type": "string",
                ...
                "resources": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/uimodels.MaintenanceViewResource"
                    }
                },
                "scope": {
                    "type": "string"
        ...
        "uimodels.MaintenanceViewResource": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "string",
        ...
        "uimodels.MaintenanceViewResponse": {
            "type": "object",
            "properties": {
                "actions": {
                    "$ref": "#/definitions/uimodels.MaintenanceActions"
                },
                "conflicts": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/uimodels.ConflictView"
                    }
                },
                "maintenance": {
                    "$ref": "#/definitions/uimodels.MaintenanceView"
                }
            }
        }
    },
