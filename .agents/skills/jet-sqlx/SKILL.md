---
name: jet-sqlx
description: MaintMode storage patterns with Jet ORM v2, sqlx, generated table/model packages, qrm error handling, entity/model mappers, and dbtx.Executor. Use when writing or reviewing PostgreSQL store code, typed SQL queries, model generation, mapping, filtering, locking, pagination, or transactional database operations.
---
...
Run this after applying migrations that change PostgreSQL tables, columns, or types.
